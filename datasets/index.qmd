...
The "[Lion CIty Soundscapes](https://doi.org/10.21979/N9/AVHSBX)" dataset consists of audiovisual recordings from 62 locations in Singapore. The locations are categorised perceptually into "[Full of Life & Exciting]{style="color: #CE2E6C"}", "[Calm & Tranquil]{style="color: #FFB5B5"}", "[Lifeless & Boring]{style="color: #F0DECB"}", and "[Chaotic & Restless]{style="color: #504658"}". In addition to the markers, this leaflet map contains ISO Pleasantness and ISO Eventfulness (ISO 12913-3) map layers computed from binaural recordings at each site.
