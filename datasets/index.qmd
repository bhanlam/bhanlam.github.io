...
pacman::p_load(tidyverse, gstat, sp, sf, raster, leaflet, leaflet.extras, osmdata, geojsonio)
```
...
# Read your GeoJSON files
isoev_geojson_for_ojs <- geojsonio::geojson_read("../data/r_isoev.geojson")
isopl_geojson_for_ojs <- geojsonio::geojson_read("../data/r_isopl.geojson")

# Read your color JSON files
isopl_colors_for_ojs <- jsonlite::read_json("../data/isopl_colors.json")
isoev_colors_for_ojs <- jsonlite::read_json("../data/isoev_colors.json")

# Pass the data to Observable
ojs_define(isoevGeoJson = isoev_geojson_for_ojs)
ojs_define(isoplGeoJson = isopl_geojson_for_ojs)
ojs_define(isoplColors = isopl_colors_for_ojs)
ojs_define(isoevColors = isoev_colors_for_ojs)

# Function to encode image to base64
encode_image <- function(path) {
  raw_img <- readBin(path, "raw", file.info(path)$size)
  paste0("data:image/png;base64,", base64enc::base64encode(raw_img))
}

# Encode your images
calm_icon_for_ojs <- encode_image("../data/icons/pin_calm.png")
chaotic_icon_for_ojs <- encode_image("../data/icons/pin_chaotic.png")
vibrant_icon_for_ojs <- encode_image("../data/icons/pin_vibrant.png")
monotonous_icon_for_ojs <- encode_image("../data/icons/pin_boring.png")

# Pass to Observable
ojs_define(calm_icon = calm_icon_for_ojs)
ojs_define(chaotic_icon = chaotic_icon_for_ojs)
ojs_define(vibrant_icon = vibrant_icon_for_ojs)
ojs_define(monotonous_icon = monotonous_icon_for_ojs)
```
